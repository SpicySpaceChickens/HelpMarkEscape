...
if "%ANDROIDHOME%"=="" set ANDROIDHOME=C:\Users\aless\AppData\Local\Android\Sdk
...
%ADB% %DEVICE% install Help_Mark_Escape-Android-Shipping-armv7.apk
@if "%ERRORLEVEL%" NEQ "0" goto Error
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/Help_Mark_Escape
%ADB% %DEVICE% shell rm -r %STORAGE%/UE4Game/UE4CommandLine.txt
%ADB% %DEVICE% shell rm -r %STORAGE%/obb/com.SpicySpaceChickens.HelpMarkEscape
%ADB% %DEVICE% shell rm -r %STORAGE%/Android/obb/com.SpicySpaceChickens.HelpMarkEscape
%ADB% %DEVICE% shell rm -r %STORAGE%/Download/obb/com.SpicySpaceChickens.HelpMarkEscape
